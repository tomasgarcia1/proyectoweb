...
(1, 0, 160, 2500.0, "marta@m.com", '1999-01-01', 500.90, "db1a4c0c96fd1f7daf946ae3f066c3a55b339fab3043becfa479e0cd5e023cfc", 63.0, 1, 1,"martita", 1),
...
insert into cupondescuento values (1, 1, '2020-07-15', 200, 1);
insert into moldecupon values (1, 1, 100);
insert into moldecupon values (2, 1, 200);
...
(4, 188,  0.5, 5,"Pollo al horno",  7.35, "Pollo al horno", 100.0, 28.69,1),
...
insert into pedido (id, estado, fecha, precio, ubicacionDestino_id,usuario_id) values(1,3, '2020-01-03',280,1,1);
insert into pedido (id, estado, fecha, precio, ubicacionDestino_id,usuario_id) values(2,3, '2020-02-04',280,2,1); 
insert into pedido (id, estado, fecha, precio, ubicacionDestino_id,usuario_id) values(3,3, '2020-02-05',280,3,1);
insert into pedido (id, estado, fecha, precio, ubicacionDestino_id,usuario_id) values(4,3, '2020-03-06',280,4,1); 
insert into pedido (id, estado, fecha, precio, ubicacionDestino_id,usuario_id) values(5,3, '2020-04-09',280,1,1);
insert into pedido (id, estado, fecha, precio, ubicacionDestino_id,usuario_id) values(6,3, '2020-05-25',280,1,1);
insert into pedido (id, estado, fecha, precio, ubicacionDestino_id,usuario_id) values(8,3, '2020-06-12',280,4,1);
insert into pedido (id, estado, fecha, precio, ubicacionDestino_id,usuario_id) values(7,3, '2020-06-28',280,3,1);
insert into pedido (id, estado, fecha, precio, ubicacionDestino_id,usuario_id) values(9,3, '2020-07-12',280,5,1);
insert into pedido (id, estado, fecha, precio, ubicacionDestino_id,usuario_id) values(10,3, '2020-07-13',280,2,1);
insert into pedido (id, estado, fecha, precio, ubicacionDestino_id,usuario_id) values(11,3, '2020-07-14',280,5,1);
insert into pedido (id, estado, fecha, precio, ubicacionDestino_id,usuario_id) values(12,3, '2020-07-15',280,6,1);
