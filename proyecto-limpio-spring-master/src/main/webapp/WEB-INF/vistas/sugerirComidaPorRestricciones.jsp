...
<body>
    ...
    <section>
        <h1>Su Desayuno es : ${desayuno.nombre}, Precio: $ ${desayuno.precio}</h1>
        <br>
        <h1>Su Almuerzo es: ${almuerzo.nombre}, Precio: $ ${almuerzo.precio}</h1>
        <br>
        <h1>Su Cena es: ${cena.nombre}, Precio: $ ${cena.precio}</h1>
        <br>
    </section>
